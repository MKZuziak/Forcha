...
def simulation():
    ...
    settings = init_settings(
         ...
         allow_default=True)
    with open(r'/home/mzuziak/snap/snapd-desktop-integration/83/Documents/Forcha/forcha/tests/test_runs/contrib_mnist/test/dataset/MNIST_5_dataset', 'rb') as path:
    ...
    orchestrator = Evaluator_Orchestrator(settings, full_debug = False)
