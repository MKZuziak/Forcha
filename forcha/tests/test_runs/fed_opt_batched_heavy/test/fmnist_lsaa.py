...
def simulation():
    ...
    settings = init_settings(
         ...
         allow_default=True)
    with open(r'/home/mzuziak/snap/snapd-desktop-integration/83/Documents/Forcha/forcha/tests/test_runs/fed_opt_batched_heavy/test/dataset/FMNIST_12_dataset', 'rb') as path:
