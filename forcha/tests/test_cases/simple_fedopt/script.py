...
def simulation():
    cwd = os.getcwd()
    config = basic_fedavg(iterations=30,
                          number_of_nodes=20,
                          sample_size=10,
                          root_path=cwd,
                          local_lr=0.1,
    ...
    with open(r'/home/mzuziak/snap/snapd-desktop-integration/83/Documents/Forcha/forcha/tests/test_cases/dataset/MNIST_20_dataset_pointers', 'rb') as path:
